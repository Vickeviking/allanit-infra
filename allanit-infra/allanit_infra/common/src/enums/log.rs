...
impl From<usize> for LogActionEnum {
    fn from(idx: usize) -> Self {
        match idx {
            ...
            14 => LogActionEnum::DbConnectionFailed,
            15 => LogActionEnum::CampaignCreated,
            16 => LogActionEnum::CampaignQueued,
            17 => LogActionEnum::CampaignDispatched,
            18 => LogActionEnum::CampaignCompleted,
            19 => LogActionEnum::MailAcceptedByProvider,
            20 => LogActionEnum::MailDelivered,
            21 => LogActionEnum::MailOpened,
            22 => LogActionEnum::MailClicked,
            23 => LogActionEnum::MailBounced,
            24 => LogActionEnum::MailFailed,
            25 => LogActionEnum::ApiRequest,
            26 => LogActionEnum::ApiResponseError,
            27 => LogActionEnum::DebugPulse,
            28 => LogActionEnum::DebugModuleActive,
            29 => LogActionEnum::DebugPipeMessage,
            30 => LogActionEnum::DebugEventReceived,
            31 => LogActionEnum::DebugNotificationSent,
            32 => LogActionEnum::MessageReceived,
...
impl fmt::Display for LogActionEnum {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let s = match self {
            ...
            LogActionEnum::DbConnectionFailed => "DbConnectionFailed",
...
impl FromStr for LogActionEnum {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "DbConnectionFailed" => Ok(LogActionEnum::DbConnectionFailed),
...
impl FromSql<Text, Pg> for LogActionEnum {
    fn from_sql(value: PgValue<'_>) -> diesel::deserialize::Result<Self> {
        match value.as_bytes() {
            ...
            b"DbConnectionFailed" => Ok(LogActionEnum::DbConnectionFailed),
...
impl ToSql<Text, Pg> for LogActionEnum {
    fn to_sql<'b>(
        ...
        match self {
            ...
            LogActionEnum::DbConnectionFailed => out.write_all(b"DbConnectionFailed")?,
